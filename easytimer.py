...
with open(newScript, 'w+') as sScript:
    ...
    sScript.write('# This whole script was automatically created by another script.\n')
...
time.sleep(1)
print('\nYour script has been created, and also is executable.')
subprocess.call('sudo chmod +x {}'.format(newScript), shell=True)
print('To run your script type: python3', newScript)
print('')
